...
ALTER TABLE MINI_ERP.MONEY_SAVE ADD VERSION int NULL;
ALTER TABLE MINI_ERP.ACCOUNT_OPER ADD VERSION int NULL;

UPDATE  MINI_ERP.MONEY_SAVE SET VERSION = 0;
UPDATE  MINI_ERP.ACCOUNT_OPER SET VERSION = 0;