...
--  20140406-12  payfirst


UPDATE ACCOUNT_OPER SET ADVANCE_RECEIVABLE = 130, ACCOUNTS_RECEIVABLE = 0 , PROXY_ACCOUNTS_RECEIVABLE = 0 WHERE ID='ff808081452835560145358ebf5e015d';

UPDATE CUSTOMER SET ADVANCE_MONEY = ADVANCE_MONEY + 130 where ID='ff8080814513df6d014516789b5c00ce';

UPDATE CUSTOMER_ORDER SET ADVANCE_MONEY = 130 where id='20140406-12';
