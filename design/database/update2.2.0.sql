...
-- 第二个循环
      oper_loop: LOOP -- Loop through class in grade.
        ...
        THEN
          UPDATE ACCOUNT_OPER SET ACCOUNT_OPER.PROXY_ACCOUNTS_RECEIVABLE = ACCOUNT_OPER.OPER_MONEY;
        ...
        IF _ORDER_PAY_TYPE <> 'EXPRESS_PROXY'
        THEN
          UPDATE ACCOUNT_OPER SET ACCOUNT_OPER.ACCOUNTS_RECEIVABLE = ACCOUNT_OPER.OPER_MONEY;
        END IF;
