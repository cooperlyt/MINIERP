...
DROP TABLE DB_PLAT_SYSTEM.BUSINESS_TASK;
DROP TABLE DB_PLAT_SYSTEM.BUSINESS_INSTANCE;
...
CREATE TABLE DB_PLAT_SYSTEM.BUSINESS_TASK
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
...
CREATE TABLE DB_PLAT_SYSTEM.BUSINESS_INSTANCE
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
...
ALTER TABLE DB_PLAT_SYSTEM.BUSINESS_INSTANCE
...
ALTER TABLE DB_PLAT_SYSTEM.BUSINESS_TASK
...
ALTER TABLE DB_PLAT_SYSTEM.BUSINESS_TASK
	...
	REFERENCES DB_PLAT_SYSTEM.BUSINESS_INSTANCE (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
