...
DROP TABLE MINI_ERP.STORE_RES_REBATE;
DROP TABLE MINI_ERP.ORDER_ITEM_REBATE;
DROP TABLE MINI_ERP.PRODUCT_GROUP_RES;
DROP TABLE MINI_ERP.BACK_ITEM;
DROP TABLE MINI_ERP.OWE_OUT;
DROP TABLE MINI_ERP.PRICE_ITEM;
...
DROP TABLE MINI_ERP.SALE_PLOY_REBATE;
DROP TABLE MINI_ERP.CUSTOMER_ORDER;
DROP TABLE MINI_ERP.QUOTED_PRICE;
...
DROP TABLE MINI_ERP.BANK_ACCOUNT;
DROP TABLE MINI_ERP.RES_CATEGORY;
DROP TABLE MINI_ERP.REBATE_PROGRAM;
...
(
	...
	BANK_ACCOUNT VARCHAR(100) COMMENT '帐号',
...
B  固定金额',
	...
	STOCK_CHANGE_ITEM VARCHAR(32) COMMENT 'STOCK_CHANGE_ITEM',
	OVERLAY_OUT BIT(1) NOT NULL COMMENT 'OVERLAY_OUT',
	NEED_CONVERSION_RATE DECIMAL(19,10) COMMENT '订购转换率',
	TOTAL_MONEY DECIMAL(19,3) COMMENT 'TOTAL_MONEY',
	NEED_TOTAL_MONEY DECIMAL(19,3) COMMENT 'NEED_TOTAL_MONEY',
	PRIMARY KEY (ID)
) ENGINE = InnoDB COMMENT = '订单项' DEFAULT CHARACTER SET utf8;


CREATE TABLE MINI_ERP.BACK_DISPATCH_ITEM
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
	COUNT DECIMAL(19,4) NOT NULL COMMENT '件数',
	STORE_RES VARCHAR(32) NOT NULL COMMENT 'STORE_RES',
	PRODUCT_STORE_IN VARCHAR(32) NOT NULL COMMENT '入库',
	PRIMARY KEY (ID)
) ENGINE = InnoDB COMMENT = '退货调度' DEFAULT CHARACTER SET utf8;
...
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
	CUSTOMER_ORDER VARCHAR(32) COMMENT '订单',
	REASON VARCHAR(32) NOT NULL COMMENT '原因',
	VERSION INT COMMENT 'VERSION',
	CREATE_DATE DATETIME NOT NULL COMMENT '建立时间',
	MEMO VARCHAR(200) COMMENT '备注',
	...
	MONEY DECIMAL(19,3) NOT NULL COMMENT '金额',
	SAVE_MONEY DECIMAL(19,3) NOT NULL COMMENT '保留款',
	CUSTOMER VARCHAR(32) NOT NULL COMMENT 'CUSTOMER',
...
(
	NUMBER VARCHAR(100) NOT NULL COMMENT '帐号',
...
B  固定金额',
	...
	RES_MONEY DECIMAL(19,3) COMMENT '货款',
	PRIMARY KEY (ID)
...
CREATE TABLE MINI_ERP.SALE_PLOY_REBATE
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
	NAME VARCHAR(10) NOT NULL COMMENT 'NAME',
	REBATE_MONEY DECIMAL(19,3) NOT NULL COMMENT 'REBATE_MONEY',
	CUSTOMER_ORDER VARCHAR(32) NOT NULL COMMENT 'CUSTOMER_ORDER',
	PRIMARY KEY (ID)
) ENGINE = InnoDB COMMENT = '销售策略金额' DEFAULT CHARACTER SET utf8;
...
ALTER TABLE MINI_ERP.BACK_DISPATCH_ITEM
	ADD FOREIGN KEY (PRODUCT_STORE_IN)
	REFERENCES MINI_ERP.PRODUCT_BACK_STORE_IN (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE MINI_ERP.SALE_PLOY_REBATE
	ADD FOREIGN KEY (CUSTOMER_ORDER)
	REFERENCES MINI_ERP.CUSTOMER_ORDER (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
