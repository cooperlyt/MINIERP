...
INSERT INTO MINI_ERP.ACCOUNTING (ID, NAME, PARENT, CURRENCY, DIRECTION, TYPE, LEVEL) VALUES ('1001', '现金', null, 'RMB', 'DBEDIT', 'finance.accountType.Asset', 1);
INSERT INTO MINI_ERP.ACCOUNTING (ID, NAME, PARENT, CURRENCY, DIRECTION, TYPE, LEVEL) VALUES ('1002', '银行存款', null, 'RMB', 'DBEDIT', 'finance.accountType.Asset', 1);
INSERT INTO MINI_ERP.ACCOUNTING (ID, NAME, PARENT, CURRENCY, DIRECTION, TYPE, LEVEL) VALUES ('1122', '应收账款', null, 'RMB', 'DBEDIT', 'finance.accountType.Asset', 1);
INSERT INTO MINI_ERP.ACCOUNTING (ID, NAME, PARENT, CURRENCY, DIRECTION, TYPE, LEVEL) VALUES ('112201', '应收账款', '1122', 'RMB', 'DBEDIT', 'finance.accountType.Asset', 2);
INSERT INTO MINI_ERP.ACCOUNTING (ID, NAME, PARENT, CURRENCY, DIRECTION, TYPE, LEVEL) VALUES ('112202', '代收应收账款', '1122', 'RMB', 'DBEDIT', 'finance.accountType.Asset', 2);
INSERT INTO MINI_ERP.ACCOUNTING (ID, NAME, PARENT, CURRENCY, DIRECTION, TYPE, LEVEL) VALUES ('2203', '预收账款', null, 'RMB', 'CREDIT', 'finance.accountType.Liability', 1);
INSERT INTO MINI_ERP.ACCOUNTING (ID, NAME, PARENT, CURRENCY, DIRECTION, TYPE, LEVEL) VALUES ('6001', '主营业务收入', null, 'RMB', 'CREDIT', 'finance.accountType.profitLoss', 1);
INSERT INTO MINI_ERP.ACCOUNTING (ID, NAME, PARENT, CURRENCY, DIRECTION, TYPE, LEVEL) VALUES ('6602', '管理费用', null, 'RMB', 'DBEDIT', 'finance.accountType.profitLoss', 1);
...
UPDATE DG_SYSTEM.FUNC_CATEGORY SET NAME = '财务功能' WHERE ID = 'finance.config';
UPDATE DG_SYSTEM.FUNCTION SET CATEGORY = 'finance.config' WHERE ID = 'erp.cashier.moneySave';
