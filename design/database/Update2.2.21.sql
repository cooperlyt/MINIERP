...
ALTER TABLE MINI_ERP.INVENTORY ADD CHECK_YEAR int NOT NULL;
ALTER TABLE MINI_ERP.INVENTORY ADD CHECK_MONTH int NOT NULL;

UPDATE MINI_ERP.INVENTORY SET CHECK_YEAR = 0,CHECK_MONTH=0;
