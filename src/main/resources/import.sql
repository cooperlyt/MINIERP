...
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.finance.customerAccount','STRING','112201','客户应收账款科目代码');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.finance.proxyAccount','STRING','112202','客户代收应收账款科目代码');
...
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.finance.beginningDay','INTEGER','12','结算起始日');

INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.ad.DEPOSIT_BACK','%s 退预存款','112201','退预存款 预收账款');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.s.DEPOSIT_BACK','%s 退款存入','112201','退预存款');

INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.pac.PROXY_SAVINGS','%s 代收款','112201','代收存入 代收应收账款');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.s.PROXY_SAVINGS','%s 代收存入','112201','代收存入');

INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.ad.CUSTOMER_SAVINGS','%s 客户预存','112201','客户存款 预收账款');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.ac.CUSTOMER_SAVINGS','%s 客户支付','112201','客户存款 应收账款');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.o.CUSTOMER_SAVINGS','%s 客户存入','112201','客户存款');

INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.ad.DEPOSIT_PAY','%s 支付货款','112201','支付货款 预收账款');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.ac.DEPOSIT_PAY','%s 支付货款','112201','支付货款 应收账款');


INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.mf.MONEY_FREE','%s 减免','112201','减免 管理费用');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.ac.MONEY_FREE','%s 减免货款','112201','减免 应收账款');

INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.ad.ORDER_PAY','%s 支付货款','112201','订单支付 预收账款');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.ac.ORDER_PAY','%s 赊款发货','112201','订单支付 应收账款');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.pac.ORDER_PAY','%s 代收发货','112201','订单支付 应收账款');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.rm.ORDER_PAY','%s 赊发货款','112201','支付货款 主营业务收入');

INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.ac.ORDER_BACK','%s 退货冲账','112201','退货退款 应收账款');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.rm.ORDER_BACK','%s 退货冲账','112201','退货退款 主营业务收入');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.ad.ORDER_BACK','%s 退货存入','112201','退货退款 预收账款');
INSERT INTO DG_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('erp.ADF.ac.c.ORDER_BACK','%s 退货退款','112201','退货退款 应收账款');
...
INSERT INTO DG_SYSTEM.BUSINESS_DEFINE(ID, NAME, WF_NAME, START_PAGE, START_DATA_VALIDATOR, TASK_SERVICE, CATEGORY, MEMO, VERSION) VALUES('erp.business.orderCancel',' ','orderCancel','/business/startPrepare/erp/sale/StoreResBackCreate.xhtml','','','erp.sale','客户退货',0);
...
INSERT INTO DG_SYSTEM.FUNCTION (ID, NAME, CATEGORY, ICON, LOCATION, BANNER, PRIORITY, MEMO) VALUES ('erp.store.inventory','盘点','erp.storage.mgr','','/func/erp/store/Inventory.seam','','1','盘点');



INSERT INTO DG_SYSTEM.FUNCTION (ID, NAME, CATEGORY, ICON, LOCATION, BANNER, PRIORITY, MEMO) VALUES ('erp.store.stockSearch','库存查询','erp.res.mgr','','/func/erp/search/StockSearch.seam','','1','库存查询');
...
INSERT INTO DG_SYSTEM.FUNCTION (ID, NAME, CATEGORY, ICON, LOCATION, BANNER, PRIORITY, MEMO) VALUES ('erp.sale.myOrder','订单','erp.sale.mgr','','/func/erp/sale/CustomerOrder.seam','','10','');
...
INSERT INTO DG_SYSTEM.FUNCTION (ID, NAME, CATEGORY, ICON, LOCATION, BANNER, PRIORITY, MEMO) VALUES ('erp.sale.customerContact','客户通讯录','erp.sale.mgr','','/func/erp/sale/CustomerContact.seam','','4','');
...
INSERT INTO DG_SYSTEM.FUNCTION (ID, NAME, CATEGORY, ICON, LOCATION, BANNER, PRIORITY, MEMO) VALUES ('finance.config.accounting','科目设置','finance.config','','/func/erp/finance/accountancy/AccountingMgr.seam','','1','');
...
INSERT INTO DG_SYSTEM.FUNCTION (ID, NAME, CATEGORY, ICON, LOCATION, BANNER, PRIORITY, MEMO) VALUES ('erp.transport.carMgr','车辆管理','erp.transport','','/func/erp/transport/CarsMgr.seam','','1','');
...
INSERT INTO DG_SYSTEM.FUNCTION (ID, NAME, CATEGORY, ICON, LOCATION, BANNER, PRIORITY, MEMO) VALUES ('erp.search.customerShip','客户货品往来明细','erp.search','','/func/erp/sale/SaleCustomerShipReport.seam','','400','');
...
INSERT INTO DG_SYSTEM.FUNCTION (ID, NAME, CATEGORY, ICON, LOCATION, BANNER, PRIORITY, MEMO) VALUES ('erp.search.sallInOutDayReoper','货品往来分组汇总','erp.search','','/func/erp/sale/CustomerResTotal.seam','','500','');
INSERT INTO DG_SYSTEM.FUNCTION (ID, NAME, CATEGORY, ICON, LOCATION, BANNER, PRIORITY, MEMO) VALUES ('erp.search.customerMoneyReport','客户货款往来','erp.search','','/func/erp/sale/CustomerMoneyReport.seam','','500','');

INSERT INTO DG_SYSTEM.FUNCTION (ID, NAME, CATEGORY, ICON, LOCATION, BANNER, PRIORITY, MEMO) VALUES ('erp.total.customerBalance','客户帐户分析','erp.total','','/func/erp/total/customerMoney.seam','','100','');
...
INSERT INTO DG_SYSTEM.ROLE_FUNCTION (ROL_ID, FUN_ID) VALUES ('erp.sale.saler', 'erp.store.stockSearch');
...
INSERT INTO DG_SYSTEM.WORD(ID, _KEY, _VALUE, CATEGORY, DESCRIPTION, PRIORITY, ENABLE) VALUES ('erp.customerType.dealer','dealer','分销商','erp.customerType','','1',b'1');
INSERT INTO DG_SYSTEM.WORD(ID, _KEY, _VALUE, CATEGORY, DESCRIPTION, PRIORITY, ENABLE) VALUES ('erp.customerType.construct','construct','开发商','erp.customerType','','2',b'1');
INSERT INTO DG_SYSTEM.WORD(ID, _KEY, _VALUE, CATEGORY, DESCRIPTION, PRIORITY, ENABLE) VALUES ('erp.customerType.project','project','工程用户','erp.customerType','','2',b'1');
...
INSERT INTO DG_SYSTEM.WORD(ID, _KEY, _VALUE, CATEGORY, DESCRIPTION, PRIORITY, ENABLE) VALUES ('erp.bank.other','OTHER','其它','erp.bank','',99,b'0');
