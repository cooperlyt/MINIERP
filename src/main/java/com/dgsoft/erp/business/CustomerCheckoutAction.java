...
public class CustomerCheckoutAction {
    ...
    private Account getCustomerADAccount(Customer customer) {
        Account result = erpEntityManager.find(Account.class, getCustomerADCode(customer));
        if (result == null) {
    ...
    private Account getCustomerACAccount(Customer customer) {
        Account result = erpEntityManager.find(Account.class, getCustomerACCode(customer));
        if (result == null) {
            return new Account();//TODO fill
        }
        return result;
    ...
    private Account getCustomerPACAccount(Customer customer) {
        Account result = erpEntityManager.find(Account.class, getCustomerPACCode(customer));
        if (result == null) {
            return new Account();//TODO fill
        }
        return result;
